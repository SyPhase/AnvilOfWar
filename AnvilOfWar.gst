...
<gameSystem id="sys-4d6c-ac3c-296b-de59" name="Anvil Of War" battleScribeVersion="2.03" revision="13" type="gameSystem" xmlns="http://www.battlescribe.net/schema/gameSystemSchema" authorName="Pierce Kester" authorContact="bulletgiraffe@gmail.com" authorUrl="bulletgiraffe.com" publicationId="5911-3a66-ec62-32e6">
  <categoryEntries>
  ...
  <forceEntries>
    <forceEntry name="Galactic Conquest" id="2936-ac7b-690d-0867" hidden="false" sortIndex="2">
      ...
      <forceEntries>
        <forceEntry name="Planetary Fleet" id="f4f6-3a2d-b765-7af6" hidden="false">
        ...
        <forceEntry name="Planetary Battle" id="b29e-7c80-963e-ca97" hidden="false">
          <costs>
    ...
    <forceEntry name="Skirmish Battle" id="42b1-ad19-3497-d664" hidden="false" sortIndex="1">
      <categoryLinks>
